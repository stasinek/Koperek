...
public:
    ...
    void setupUi(QDialog *TWizard_form)
    {
        ...
        retranslateUi(TWizard_form);
        QObject::connect(buttonBox, SIGNAL(accepted()), TWizard_form, SLOT(accept()));
        QObject::connect(buttonBox, SIGNAL(rejected()), TWizard_form, SLOT(reject()));

        tabWidget->setCurrentIndex(2);


        QMetaObject::connectSlotsByName(TWizard_form);
    } // setupUi
...
namespace Ui {
    class TWizard_form: public Ui_TWizard_form {};
} // namespace Ui

QT_END_NAMESPACE

#endif // UI_TWIZARD_FORM_H
