...
TJournal_form::TJournal_form(QWidget *a_parent) :
    QDialog(a_parent),
	ui(new Ui::TJournal_form)
{
	ui->setupUi(this);
}

TJournal_form::~TJournal_form()
{
	delete ui;
}

void TJournal_form::on_buttonBox_clicked(QAbstractButton *a_button)
{
