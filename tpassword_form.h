...
#ifndef TPASSWORD_FORM_H
#define TPASSWORD_FORM_H

#include <QDialog>

namespace Ui {
    class TPassword_form;
}

class TPassword_form : public QDialog
{
    Q_OBJECT

public:
    explicit TPassword_form(QWidget *parent = 0);
    ~TPassword_form();

private:
    Ui::TPassword_form *ui;
};

#endif // TPASSWORD_FORM_H
